...
- Hardware-unverified, and this module carries the most protocol surface of the five
  (the entire IDE-R/SCSI emulation in `plugins/module_utils/ider.py`). See the
